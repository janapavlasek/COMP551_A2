...
Using the Sci-Kit Learn SVM model, we acheived a score of 96.633% accuracy on
unseen testing data.
...
For running the Nearest Neighbours model please run:
...
clean data is stored to avoid the need to rerun the computationally instensive
